...
{
	$installed	= '';
	$sqlFile	= 'mod_forms.sql';
	$res		= '';
	$msg 		= '';

    //...... Set up non authenticated actions (preg_match) (if applicable)
    $plugin[$name]['non_auth_actions'][] = 'saveForm';

    //...... Set up non authenticated pages (preg_match) (if applicable)
    $plugin[$name]['non_auth_pages'][]	= 'form';
    $plugin[$name]['non_auth_pages'][]	= 'question_end';
    $plugin[$name]['non_auth_pages'][]	= 'form_complete';
    $plugin[$name]['non_auth_pages'][]	= 'question';
